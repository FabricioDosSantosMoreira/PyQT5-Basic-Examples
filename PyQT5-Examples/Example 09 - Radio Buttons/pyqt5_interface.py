...
class Ui_main_window(object):
    ...
    def setupUi(self, main_window) -> None:
        ...
        self.radio_button_1.setGeometry(QtCore.QRect(20, 20, 131, 31))
        self.radio_button_1.setObjectName("radio_button_1")

        self.radio_button_2 = QtWidgets.QRadioButton(self.central_widget)
        self.radio_button_2.setGeometry(QtCore.QRect(20, 40, 131, 31))
        self.radio_button_2.setObjectName("radio_button_2")

        self.radio_button_3 = QtWidgets.QRadioButton(self.central_widget)
        self.radio_button_3.setGeometry(QtCore.QRect(20, 60, 131, 31))
        self.radio_button_3.setObjectName("radio_button_3")

        self.out_label = QtWidgets.QLabel(self.central_widget)
        self.out_label.setGeometry(QtCore.QRect(20, 100, 291, 16))
    ...
    def retranslateUi(self, main_window) -> None:
        ...
        self.radio_button_1.setText(_translate("main_window", "Radio button 1"))
        self.radio_button_2.setText(_translate("main_window", "Radio button 2"))
        self.radio_button_3.setText(_translate("main_window", "Radio button 3"))
